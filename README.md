...
I design and build mobile apps, websites, and custom software for businesses that need reliable, production-ready work.
...
- 🔗 **Backend & API Integration** — Firebase & REST API solutions
